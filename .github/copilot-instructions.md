...
- 目的: Check your Steam wishlist and notify you via Discord of the price,
  discount rate, and the lowest price in SteamDB.
...
- 概要: Check your Steam wishlist and notify you via Discord of the price,
  discount rate, and the lowest price in SteamDB.
- 主要言語: TypeScript
- パッケージマネージャー: pnpm
